...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.providers.administrateurs.driver' => 'string',
            'auth.providers.administrateurs.model' => 'string',
            ...
            'filesystems.links.D:\wamp\www\laravel\hellocse\public\storage' => 'string',
...
'auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.administrateurs.driver',
'auth.providers.administrateurs.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.D:\\wamp\\www\\laravel\\hellocse\\public\\storage','logging.default','logging.deprecations.channel',
...
'sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','login',
'logout',);
